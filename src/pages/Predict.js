    ...
    <div className='bg-gray-900'>
      ...
      <div className='w-11/12 m-auto grid grid-cols-2 gap-2 pt-16'>
        ...
        <div className='text-white'>
          ...
          <img src={api+"/img/plat/"+data.path+data.name} className='w-5/12 m-auto'/>
          <p className='text-red-600 text-sm mt-5 underline'>*jika value yang dihasilkan berbeda/salah maka benarkan pada kolom input dibawah</p>
          <p className='mt-5'>CORRECTION?</p>
